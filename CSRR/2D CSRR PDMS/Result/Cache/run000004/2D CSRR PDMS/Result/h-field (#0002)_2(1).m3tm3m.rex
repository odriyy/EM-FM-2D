...
<MetaResultFile version="20211011" creator="FD-Control">
  ...
  <SimulationProperties fieldname="h-field (f=2.5) [2]" frequency="2.5" encoded_unit="&amp;U:A^1.:m^-1" quantity="h-field" fieldtype="H-Field" fieldscaling="PEAK" dB_Amplitude="20"/>
