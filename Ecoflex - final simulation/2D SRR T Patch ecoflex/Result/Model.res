...
result=s:1
parametric=s:P
treepath=s:1D Results\Materials\Galinstan\Surface Impedance\Z' (FD - Interpolated)
files=s:Galinstan_Z_re Frequency Domain.sig
...
parametric=s:P
treepath=s:1D Results\Materials\Galinstan\Surface Impedance\Z'' (FD - Interpolated)
files=s:Galinstan_Z_im Frequency Domain.sig
...
result=s:1
parametric=s:P
treepath=s:1D Results\Materials\2.5\ecoflex\Dispersive\Eps' (FD - Interpolated)
files=s:2.5\ecoflex_eps_re Frequency Domain.sig
...
parametric=s:P
treepath=s:1D Results\Materials\2.5\ecoflex\Dispersive\Eps'' (FD - Interpolated)
files=s:2.5\ecoflex_eps_im Frequency Domain.sig
...
result=s:1
parametric=s:P
treepath=s:1D Results\Power\Excitation [1]\Loss per Material\2.5\Volume loss in ecoflex
files=s:cVolume_loss_in_2.5_ecoflex(1).sig
