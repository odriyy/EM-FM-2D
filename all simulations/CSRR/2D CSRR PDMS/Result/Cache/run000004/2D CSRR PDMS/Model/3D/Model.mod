...
With Brick
     ...
     .Yrange "pipe_Ro+ h_sub/4", "pipe_Ro + h_sub*2/4" 
...
With Cylinder 
     ...
     .Axis "y" 
     .Yrange "pipe_Ro + (1/4*h_sub)", "pipe_Ro + (2/4*h_sub)" 
     .Xcenter "0" 
     .Zcenter "L_sub/2" 
     .Segments "0" 
     .Create 
...
With Brick
     ...
     .Yrange "pipe_Ro + (1/4*h_sub)", "pipe_Ro+ (2/4*h_sub)" 
     .Zrange "L_sub/2 -( r_CSRR - (2 * w_channel) - 0.6)", "L_sub/2 - ( r_CSRR - w_channel - 0.4)" 
     .Create
End With
...
With DiscretePort 
     ...
     .Monitor "True"
     .Radius "0.0"
     .SetP1 "True", "5.162537064507e-15", "15.5", "34"
     .SetP2 "True", "3.4607733345721e-15", "16.625", "34.5"
...
'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Pick.PickMidpointFromId "component1:GND", "70"
...
With DiscretePort 
     ...
     .Monitor "True"
     .Radius "0.0"
     .SetP1 "True", "-5.162537064507e-15", "15.5", "0"
     .SetP2 "True", "2.2204460492503e-16", "16.625", "0.5"
     .InvertDirection "False"
     .LocalCoordinates "False"
     .Wire ""
     .Position "end1"
