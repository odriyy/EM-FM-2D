...
With Brick
     ...
     .Component "component1" 
     .Material "PDMS" 
     .Xrange "pipe_Ro", "pipe_Ro+  t_microstrip" 
     .Yrange "-L2/2", "L2/2" 
     .Zrange "Z_mid - r_SRR + w_channel + spacing + margin+ L3", "Z_mid - r_SRR + w_channel + spacing + margin+ L3 + L1" 
     .Create
End With
...
With Brick
     ...
     .Component "component1" 
     .Material "PDMS" 
     .Xrange "pipe_Ro +t_SRR+h_sub", "pipe_Ro +t_SRR+h_sub+t_gnd" 
...
With Brick
     ...
     .Component "component1" 
     .Material "PDMS" 
     .Xrange "pipe_Ro +t_SRR", "pipe_Ro + t_SRR +h_sub" 
     .Yrange "-W_sub/2", "W_sub/2" 
     .Zrange "0", "L_sub" 
     .Create
End With
...
With Brick
     ...
     .Xrange "pipe_Ro", "pipe_Ro +t_microstrip" 
     .Yrange "-L4/2", "L4/2" 
     .Zrange "Z_mid - r_SRR + w_channel + spacing + margin", "Z_mid - r_SRR + w_channel + spacing + margin+L3" 
     .Create
End With
...
With Brick
     ...
     .Component "component1" 
     .Material "PDMS" 
     .Xrange "pipe_Ro - 0.1", "pipe_Ro+t_SRR" 
     .Yrange "-g_slot", "g_slot" 
     .Zrange "Z_mid - r_SRR + w_channel+ spacing", "Z_mid - r_SRR-0.1" 
     .Create
End With
...
'@ define material: Folder1/PVC_flexible
...
'@ rename block: component1:new_PDMS to: component1:pvc plastic

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.Rename "component1:new_PDMS", "pvc plastic"

'@ change material: component1:pvc pipe to: Folder1/PVC_flexible

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:pvc pipe", "Folder1/PVC_flexible"

'@ change material: component1:pvc pipe to: PVC

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:pvc pipe", "PVC"

'@ change material: component1:pvc plastic to: Folder1/PVC_flexible

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:pvc plastic", "Folder1/PVC_flexible"

'@ define material colour: Folder1/PVC_flexible
...
'@ change material: component1:Microstrip_horizontal to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:Microstrip_horizontal", "Copper (annealed)"

'@ change material: component1:Microstrip_vertical to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:Microstrip_vertical", "Copper (annealed)"

'@ change material: component1:SRR_Circle to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:SRR_Circle", "Copper (annealed)"

'@ change material and color: component1:SRR_Circle to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.SetUseIndividualColor "component1:SRR_Circle", 1
Solid.ChangeIndividualColor "component1:SRR_Circle", "255", "170", "0"

'@ change material and color: component1:Microstrip_vertical to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.SetUseIndividualColor "component1:Microstrip_vertical", 1
Solid.ChangeIndividualColor "component1:Microstrip_vertical", "255", "170", "0"

'@ change material and color: component1:Microstrip_horizontal to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.SetUseIndividualColor "component1:Microstrip_horizontal", 1
Solid.ChangeIndividualColor "component1:Microstrip_horizontal", "255", "170", "0"
...
'@ change material and color: component1:needle_1 to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:needle_1", "Copper (annealed)" 
Solid.SetUseIndividualColor "component1:needle_1", 1
Solid.ChangeIndividualColor "component1:needle_1", "255", "170", "0"
...
Solid.ChangeMaterial "component1:GND", "Copper (annealed)" 
Solid.SetUseIndividualColor "component1:GND", 1
Solid.ChangeIndividualColor "component1:GND", "255", "170", "0"
...
'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Pick.PickEdgeFromId "component1:needle_1", "1", "1"

'@ pick edge

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Pick.PickEdgeFromId "component1:needle_2", "2", "2"
...
With DiscreteFacePort 
     ...
     .Monitor "True"
     .CenterEdge "True"
     .SetP1 "True", "10.47", "0", "22.195"
     .SetP2 "True", "10.07", "0", "22.195"
     .LocalCoordinates "True"
     .InvertDirection "False"
     .UseProjection "False"
     .ReverseProjection "False"
...
'@ boolean subtract shapes: component1:GND, component1:hole_puncher1

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.Subtract "component1:GND", "component1:hole_puncher1"
...
'@ heal self intersecting of shape: component1:SRR_Circle

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.HealSelfIntersectingShape "component1:SRR_Circle"
...
'@ change material: component1:needle_2 to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.ChangeMaterial "component1:needle_2", "Copper (annealed)"

'@ change material and color: component1:needle_2 to: Copper (annealed)

'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Solid.SetUseIndividualColor "component1:needle_2", 1
Solid.ChangeIndividualColor "component1:needle_2", "255", "170", "0"
...
'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Pick.PickFaceFromId "component1:needle_1", "2"
...
'[VERSION]2024.5|33.0.1|20240614[/VERSION]
Pick.PickFaceFromId "component1:needle_2", "3"
